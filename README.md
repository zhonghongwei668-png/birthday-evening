...
一份手机端优先的私人生日晚餐邀请。体验以数字邀请函的方式逐页展开：四个轻松问题、滚动日期与时间、晚餐风格、见面方式，最后生成可保存为 PNG、可把全部选择分享给邀请人的动态邀请卡。
...
打开网页后，邀请人先填写被邀请者名字，并选择“她”“他”或中性的“TA”，再生成专属链接发给对方。被邀请者通过链接填写问题，在未来 18 个月内选择日期和晚餐安排。填写过程会暂存在当前设备，刷新后可以继续；完成后可以直接分享或复制全部选择给邀请人。
